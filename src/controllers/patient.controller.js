...
export const addPatient = async (req, res) => {
  try {
    ...
    const mhrNo = "MH" + Math.floor(10000 + Math.random() * 90000).toString();
...
export const updatePatient = async (req, res) => {
  try {
    ...
    // Remove undefined, empty string fields, and 'id'
    ...
    if (updateData.bedNo) {
      updateData.bedRoomNo = updateData.bedNo;
      delete updateData.bedNo;
    }
